...
const MyBookings = () => {
  ...
  return (
    <div className="relative px-6 md:px-16 lg:px-40 pt-30 md:pt-40 min-h-[80vh] bg-black text-[#E5E9F0]">
          ...
          >
            ...
            <div className="flex flex-col md:items-end md:text-right justify-between p-4">
              <div className="flex items-center gap-4">
                ...
                {!item.isPaid && (
                  <button className="bg-[#2978B5] px-4 py-1.5 mb-3 text-sm rounded-full font-medium cursor-pointer">
                    Pay Now
                  </button>
                )}
              </div>
